...
const InstalaredAddonCard = ({
  addon,
  installedAddon,
  downloading,
  installingAddonId,
  handleInstalarAddon,
  handleActualizarAddon,
  ...
  const needsActualizar = installedAddon && installedVersion !== backendVersion;
        ...
        <div className="wrapper d-flex align-items-center">
          ...
          <div className="details d-flex justify-content-between flex-wrap">
            <div className="addon-title text-light fw-bold">
              ...
              {!isCorrupted && installedAddon && !needsActualizar && (
                <Tippy content="Instalared with the latest version">
                  <i className="bi bi-check-circle-fill text-success ms-2"></i>
                </Tippy>
              )}
              {installedAddon && needsActualizar && !isCorrupted && (
                <Tippy content="Available Actualizar">
            ...
            <div className="ms-auto align-self-center d-flex align-items-center">
              {isCorrupted && (
                <button
                  ...
                  onClick={(e) => handleInstalarAddon(addon, e)}
                >
              ...
              {needsActualizar ? (
                <button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    handleActualizarAddon(addon); // Trigger update if available
                  }}
...
export default InstalaredAddonCard;