...
const ContextMenu = ({
  ...
  const renderOpenFolderMenu = () => {
    if (!isInstalared || folderList.length === 0) return null;
          ...
          <div className="context-menu-bottom w-100">
            ...
            <ul className="list-unstyled m-0">
                ...
                <button
                  ...
                  onClick={(e) => {
                    if (isInstalared) {
                      ...
                      onInstalar(addonData, e);
                    }
                  }}
                >
                  <span>
                    <i className="bi bi-download me-2"></i>
                    {isInstalared ? "Reinstall" : "Instalar"}
                  </span>
                </button>
              </li>
              ...
              <li>
                <button
                  className="btn btn-link text-decoration-none p-2 w-100 d-flex justify-content-between"
                  onClick={onViewOnWarperia-TDLO}
                >
                  <span><i className="bi bi-globe me-2"></i> View on Warperia-TDLO</span>
                  <i className="bi bi-box-arrow-up-right"></i>
                </button>
              </li>
              {isInstalared && (
