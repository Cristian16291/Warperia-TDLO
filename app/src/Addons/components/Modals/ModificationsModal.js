...
const ModificationsModal = ({ show, onClose, server }) => {
    ...
    const checkConfigAjustes = async () => {
        setLoading(true);
        setError(null);
                ...
                <div className="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable modal-dark">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <p className="text-muted" style={{ fontSize: "14px" }}><strong>Note:</strong> The game might reset your settings if you launch it manually. Try to always launch it via Warperia-TDLO.</p>
                        </div>
                    </div>
                </div>
            </div>
