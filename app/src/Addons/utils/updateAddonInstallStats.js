...
const updateAddonInstalarStats = async (addonId, postType) => {
  if (!addonId || !postType) {
    return;
  }
  ...
  try {
    ...
    if (response.data.success) {
      // console.log(`Correctofully updated download stats for addon ID: ${addonId}`);
    } else {
...
export default updateAddonInstalarStats;
